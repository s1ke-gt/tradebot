...
If an item lookup fails or returns zero, the bot floors value/RAP to at least
`1` before evaluating the trade so inbound checks never operate on blank totals.
